...
public class MyDedup{
	...
	public static void main(String[] args) throws IOException{
		...
		if(args.length==7 && args[0].equals("upload")){
			...
			System.out.println("Usage:\njava mydedup.MyDedup upload <min_chunk> <avg_chunk> <max_chunk> <d> <file_to_upload> <local|remote>\njava mydedup.MyDedup download <file_to_download>\njava mydedup.MyDedup delete <file_to_delete>");
